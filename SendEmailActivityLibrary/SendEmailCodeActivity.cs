...
namespace SendEmailActivityLibrary
{
    public sealed class SendEmailCodeActivity : CodeActivity
    {
        ...
        protected override void Execute(CodeActivityContext context)
        {
            ...
            smtp.Credentials =
                new System.Net.NetworkCredential(userName.Get(context), password.Get(context));
            smtp.EnableSsl = true;
